...
data_x = pd.read_excel('../data/transfer_D.xlsx', sheet_name='UV').values[:, None]
data_y = pd.read_excel('../data/transfer_D.xlsx', sheet_name='metals')
col = data_y.columns  # ['Co', 'Ni', 'Cu', 'Mg', 'Cd', 'Zn']
dropout = {'Co': 0.25, 'Ni': 0.5, 'Cu': 0.75, 'Mg': 0.25, 'Mn': 0.75, 'Zn': 0.5}
source_col = pd.read_excel('../data/data.xlsx', sheet_name='metals').columns

file = 'model/S2C_Model_D'
